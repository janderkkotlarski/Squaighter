...
class punch
{
    ...
    const float m_max_stretch{10.0f};
...
class square
{
    ...
    void display_punch(sf::RenderWindow& window)
    {
    ...
    while (window.isOpen())
    {
        ...
        while (loop_mode != 10)
        {
            ...
            if (loop_mode == 0)
            {
                ...
                lefter.display_punch(window);
                righter.display_punch(window);
